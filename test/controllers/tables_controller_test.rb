...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { discount: @table.discount, expiration_date: @table.expiration_date, name: @table.name, situacao: @table.situacao }
    end
  ...
  test "should update table" do
    patch :update, id: @table, table: { discount: @table.discount, expiration_date: @table.expiration_date, name: @table.name, situacao: @table.situacao }
    assert_redirected_to table_path(assigns(:table))
  end
